...
namespace Nest.Framework.Core
{
    public class BarFactroy
    {
        ...
        /// 设置操作按钮是否可用
        /// </summary>
        /// <param name="addEnable">新增</param>
        /// <param name="delEnable">删除</param>
        /// <param name="queryEnable">查询</param>
        /// <param name="updEnable">修改</param>
        /// <param name="exportEnable">导出</param>
        /// <param name="importEnable">导入</param>
        /// <param name="reportEnable">报表</param>
        /// <param name="stopEnable">停止查询</param>
        /// <param name="saveEnable">保存</param>
        /// <param name="clearEnable">清空</param>
        private void SetButtonEnable(bool addEnable = false, bool delEnable = false, bool queryEnable = false, bool updEnable = false,
            bool exportEnable = false, bool importEnable = false, bool reportEnable = false, bool stopEnable = false, bool saveEnable = false, bool clearEnable = false)
        {
            this.SystemApplicaiton.BarButtonAdd.Enabled = addEnable;
            this.SystemApplicaiton.BarButtonDel.Enabled = delEnable;
            this.SystemApplicaiton.BarButtonQuery.Enabled = queryEnable;
            this.SystemApplicaiton.BarButtonUpdate.Enabled = updEnable;
            this.SystemApplicaiton.BarButtonExport.Enabled = exportEnable;
            this.SystemApplicaiton.BarButtonImport.Enabled = importEnable;
            this.SystemApplicaiton.BarButtonReport.Enabled = reportEnable;
            this.SystemApplicaiton.BarButtonStop.Enabled = stopEnable;
            this.SystemApplicaiton.BarButtonSave.Enabled = saveEnable;
            this.SystemApplicaiton.BarButtonClear.Enabled = clearEnable;
        }
        ...
        public void InitControl()
        {
            try
            {
                ...
                if (dockBar != null)
                {
                    ...
                    {
                        IPlugin plugin = (IPlugin)dockBar;
                        SetButtonEnable(true, true, false, true);
            ...
            {
                //throw new Exception("Nest.Framework.Core,BarFactroy.InitControl：" + ex.Message);
                System.Windows.Forms.MessageBox.Show("Nest.Framework.Core,BarFactroy.InitControl：" + ex.Message);
            }
        }
    }
}
