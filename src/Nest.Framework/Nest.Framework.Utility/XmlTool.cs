...
namespace Nest.Framework.Utility
{
    ...
    public class XmlTool
    {
        ...
        /// <summary>
        /// 新节点内容。
        /// 示例：xmlTool.Update("Book/Authors[ISBN=\"0002\"]/Content","ppppppp");
        /// </summary>
        /// <param name="XmlPathNode"></param>
        /// <param name="Content"></param>
        public void Update(string XmlPathNode, string Content)
        {
            //更新节点内容。
        ...
        // 更新元素内容
        // xmlTool.Update("Book/Authors[ISBN=\"0002\"]/Content","ppppppp");
        // xmlTool.Save();
